...
-- Main sub-tabs
local MainTabs = {
    Eggs = Tabs.Main:AddSubTab({ Name = "Farming", Icon = "wheat" }),
...
InfoGameBox:AddButton({
    ...
    Tooltip = "Copies a rejoin script for this exact server"
})
...
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Buy All Gear (1-25)</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Buy Selected Gear</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Quick Actions (Collect / Rebirth / Sell / Open)</font>' })
...
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Execute / Auto Reconnect</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Hide UI / Anti AFK / No Pause</font>' })
...
AddFeatureToggle(FarmBox, "AutoRebirth", {
    Text = "Auto Rebirth",
    Tooltip = "Auto perform a rebirth every cycle",
    Notify = true,
}, function(Value)
...
AddFeatureToggle(FarmBox, "AutoSellAll", {
    Text = "Auto Sell All",
    Tooltip = "Auto sell all slimes every cycle",
    Notify = true,
}, function(Value)
...
QuickBox:AddButton({
    ...
    Tooltip = "Perform a rebirth"
})

QuickBox:AddButton({
    Text = "Sell All Slimes",
    Func = function()
        SellAllSlimes()
    end,
    Tooltip = "Sell all slimes at once"
})
...
AddFeatureToggle(UpgradeBox, "AutoUpgrades", {
    ...
    Tooltip = "Auto buy jump + carry upgrades every cycle",
    Notify = true,
}, function(Value)
...
AddFeatureToggle(UpgradeBox, "AutoBuySelectedUpgrades", {
    ...
    Tooltip = "Auto buy only the upgrades selected in the list",
    Notify = true,
}, function(Value)
...
AddFeatureToggle(FloorsSoccerBox, "AutoFloors", {
    ...
    Tooltip = "Auto purchase floors 1-70 every cycle",
    Notify = true,
}, function(Value)
...
AddFeatureToggle(GearBox, "AutoBuyGear", {
    ...
    Tooltip = "Auto buy the selected gears every cycle",
    Notify = true,
}, function(Value)
...
AddFeatureToggle(MenuBox, "AutoExecute", {
    ...
    Tooltip = "Automatically starts the Auto Farm loop when the script loads",
}, function(Value)
...
AddFeatureToggle(MenuBox, "AutoReconnect", {
    ...
    Tooltip = "Automatically rejoin when you get kicked or disconnected",
}, function(Value)
...
AddFeatureToggle(MenuBox, "AutoHideUi", {
    Text = "Auto Hide UI",
    Tooltip = "Automatically hides the menu 30 seconds after you open it",
}, function(Value)
...
AddFeatureToggle(MenuBox, "AntiAfk", {
    Text = "Anti AFK",
    Tooltip = "Prevents the Roblox AFK kick",
}, function(Value)
...
AddFeatureToggle(MenuBox, "NoGameplayPaused", {
    ...
    Tooltip = "Prevents gameplay from pausing when the Roblox window loses focus",
}, function(Value)
...
MenuBox:AddLabel({ Text = "Version: 5.7 - Info rework + icons + G bind" })
...
ConfigBox:AddButton({
    ...
    Tooltip = "Create a new config with the current settings"
})
...
ConfigBox:AddButton({
    ...
    Tooltip = "Overwrite the selected config with current settings"
})
...
ConfigBox:AddButton({
    ...
    Tooltip = "Reload the config list from disk"
})
...
ConfigBox:AddButton({
    ...
    Tooltip = "Load this config automatically every script start"
})
...
ConfigBox:AddButton({
    ...
    Tooltip = "Remove the autoload config"
})
...
AddFeatureToggle(ConfigBox, "AutoSave", {
    ...
    Tooltip = "Automatically save to the selected config when anything changes",
}, function(Value)
...
Notify("AntiGodHub", "Script loaded - use the Menu Bind key or Toggle button", "Success")

local DISCORD_INVITE = "https://discord.gg/jdJvZm6VdK"

do
    local prev = _G.LuaUDiscordInvite
...
local function Notify(opts)
    ...
    track(xb.MouseEnter:Connect(function() tween(xb, { TextColor3 = C.White }) end))
    track(xb.MouseLeave:Connect(function() tween(xb, { TextColor3 = C.TextDim }) end))
    track(xb.MouseButton1Click:Connect(closeNotif))
...
track(copyBtn.MouseEnter:Connect(function()
    tween(copyBtn, { BackgroundTransparency = 0.14 })
end))

track(copyBtn.MouseLeave:Connect(function()
